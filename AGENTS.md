...
* **Sprint 15** — Post-MVP Connector Framework Foundation в работе; S15-T001–T003 завершены. ADR-009, Evidence Layer Data Model и Normalization/Identity Resolution фиксируют adapter/ingestion, source/raw/assertion/binding, canonical keys, tenant resolver, manual authority и non-destructive merge boundaries. Runtime, миграции и первый connector ещё не реализованы; T006/T007 зависят от pilot signals.
