...
* **Sprint 15** — Post-MVP Connector Framework Foundation в работе; S15-T001–T006 завершены. ADR-009, Evidence Layer, Identity Resolution, Confidence/Discovery, Connector Security и Russian Market Shortlist фиксируют architecture/security contracts и research ranking. Первая validation wave: Zabbix, KSC, MaxPatrol VM, Wazuh, но source cards и demand scores остаются `PILOT DATA PENDING`; runtime, UI, миграции и первый connector не реализованы, T007 зависит от pilot signals.
