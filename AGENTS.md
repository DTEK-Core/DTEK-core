...
Это коммерческий B2B SaaS-продукт в сфере кибербезопасности, который создаёт цифровую модель доверия организации и помогает CISO, аналитикам ИБ и IT-администраторам понимать реальный уровень защищённости инфраструктуры через единый показатель — **Trust Score**.

Платформа строится вокруг четырёх ключевых сущностей:

* **Trust Passport** — цифровой паспорт доверия каждого объекта;
* **Trust Score** — взвешенная оценка доверия 0–100 по факторам безопасности;
