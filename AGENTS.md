...
* **Sprint 14** — S14-T001–T007 реализованы: master readiness checklist, environment health, manual invitation delivery, production HTTP smoke baseline, Backup & Restore Runbook, Monitoring/Error Handling Plan и Pilot Metrics/Feedback Loop; pilot data, provider activation, restore rehearsal и authenticated release-candidate gates не отмечать `PASS` без фактического прогона.
