...
* **Sprint 15** — Post-MVP Connector Framework Foundation в работе; S15-T001–T004 завершены. ADR-009, Evidence Layer, Identity Resolution и Confidence/Discovery specifications фиксируют adapter/ingestion, source/raw/assertion/binding, canonical keys, tenant resolver, manual authority, score/hard gates и human review boundaries. Runtime, UI, миграции и первый connector ещё не реализованы; T006/T007 зависят от pilot signals.
