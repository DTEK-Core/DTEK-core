...
* **Sprint 15** — Post-MVP Connector Framework Foundation в работе; S15-T001–T005 завершены. ADR-009, Evidence Layer, Identity Resolution, Confidence/Discovery и Connector Security specifications фиксируют adapter/ingestion, source/raw/assertion/binding, canonical keys, tenant resolver, manual authority, score/hard gates, Supabase Vault, connector RBAC/RLS, SSRF и safe-audit boundaries. Runtime, UI, миграции и первый connector ещё не реализованы; T006/T007 зависят от pilot signals.
