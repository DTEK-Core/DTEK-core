...
S11-T005 предоставляет два статических UTF-8 CSV-шаблона:

- `/templates/dtek-core-objects-import-template.csv`;
- `/templates/dtek-core-risks-import-template.csv`.

Оба файла используют comma delimiter, канонические имена колонок, одну валидную примерную строку и не содержат формул или данных организации. Ссылка на соответствующий шаблон доступна непосредственно в диалоге импорта.
