...
| TD-004 | Explainability model утверждена, но UI-драйверы ещё не реализованы | Пользователь пока не видит причины непосредственно в продукте | Sprint 12 T002–T006 |
