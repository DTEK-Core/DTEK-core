...
| TD-004 | Top Score Drivers реализованы, но factor reasons, impact и timeline ещё не завершены | Пользователь видит главные факторы, но пока не полный evidence-backed разбор | Sprint 12 T003–T006 |
